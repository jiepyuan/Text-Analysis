...
prior_trace_1 <- 0.05359264    
prior_trace_2 <- 0.02943369 
prior_trace_3 <- 0.1972345   

# (0) load in data --------------------------------------------------------
dat <- read.csv("nrc_combine_txt.csv")
dat$id <- 1:nrow(dat) 
...
# Focus primarily on substantive parameters; log_lik and rmse are less important for reporting convergence.
