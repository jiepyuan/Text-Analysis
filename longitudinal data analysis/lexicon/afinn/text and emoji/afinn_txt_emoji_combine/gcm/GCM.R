...
model {
  ...
  gamma00 ~ dnorm(-0.26726814, 0.1)
  gamma10 ~ dnorm(0.04647982 , 0.1)
...
alpha_init_1 <- matrix(rep(c(-0.26726814, 0.04647982), max(long_dat$id_idx)), 
                       ncol = 2, byrow = TRUE)

alpha_init_2 <- matrix(rep(c(-0.15, 0.03), max(long_dat$id_idx)), 
                       ncol = 2, byrow = TRUE)
