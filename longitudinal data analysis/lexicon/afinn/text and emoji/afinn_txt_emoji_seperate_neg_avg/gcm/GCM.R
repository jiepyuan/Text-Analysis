...
model {
  ...
  gamma00 ~ dnorm(-3.718364, 0.1)
  gamma10 ~ dnorm(0.019771 , 0.1)
...
alpha_init_1 <- matrix(rep(c(-3.718364, 0.019771), max(long_dat$id_idx)), 
                       ncol = 2, byrow = TRUE)

alpha_init_2 <- matrix(rep(c(-3.50, 0.03), max(long_dat$id_idx)), 
                       ncol = 2, byrow = TRUE)
