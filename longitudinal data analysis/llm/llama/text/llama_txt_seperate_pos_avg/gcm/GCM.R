...
prior_gcm_1 <- 0.36995662                
prior_gcm_2 <- 0.01886486                
prior_gcm_3 <- -0.01886486 
prior_gcm_4 <- 6.803462014            
prior_gcm_5 <- 0.006826637          

# (1) load and reshape the data -------------------------------------------
# 1. Convert to long format 
dat <- read.csv("llama_separate_pos_avg_txt.csv")
dat$id <- 1:nrow(dat) 
