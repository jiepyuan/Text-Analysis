...
plot_interaction(input_data = sentiment_avg_neg, response_col = "score", 
                 file_name = "afinn_separate_neg_avg_txt_emoji", 
                 y_lower = -20, y_upper = 0, line_title_position = -18, 
                 ylab = "afinn_separate_neg_avg_txt_emoji")
...
plot_interaction(input_data = sentiment_avg_neg, response_col = "score_new", 
                 file_name = "afinn_separate_neg_avg_txt_emoji_weighted", 
                 y_lower = -20, y_upper = 0, line_title_position = -18, 
                 ylab = "afinn_separate_neg_avg_txt_emoji_weighted")
...
write.csv(wide, "afinn_separate_neg_avg_txt_emoji.csv", row.names = F)
write.csv(wide_weighted, "afinn_separate_neg_avg_txt_emoji_weighted.csv", row.names = F)