...
plot_interaction(input_data = sentiment_avg_neg, response_col = "score", 
                 file_name = "afinn_separate_neg_avg_txt", 
                 y_lower = -20, y_upper = 0, line_title_position = -18, 
                 ylab = "afinn_separate_neg_avg_txt")
...
plot_interaction(input_data = sentiment_avg_neg, response_col = "score_new", 
                 file_name = "afinn_separate_neg_avg_txt_weighted", 
                 y_lower = -20, y_upper = 0, line_title_position = -18, 
                 ylab = "afinn_separate_neg_avg_txt_weighted")
...
write.csv(wide, "afinn_separate_neg_avg_txt.csv", row.names = F)
write.csv(wide_weighted, "afinn_separate_neg_avg_txt_weighted.csv", row.names = F)