...
plot_interaction(input_data = sentiment_avg_pos, response_col = "score", 
                 file_name = "afinn_separate_pos_avg_txt", 
                 y_lower = 0, y_upper = 20, line_title_position = 18, 
                 ylab = "afinn_separate_pos_avg_txt")
...
plot_interaction(input_data = sentiment_avg_pos, response_col = "score_new", 
                 file_name = "afinn_separate_pos_avg_txt_weighted", 
                 y_lower = 0, y_upper = 20, line_title_position = 18, 
                 ylab = "afinn_separate_pos_avg_txt_weighted")
...
write.csv(wide, "afinn_separate_pos_avg_txt.csv", row.names = F)
write.csv(wide_weighted, "afinn_separate_pos_avg_txt_weighted.csv", row.names = F)