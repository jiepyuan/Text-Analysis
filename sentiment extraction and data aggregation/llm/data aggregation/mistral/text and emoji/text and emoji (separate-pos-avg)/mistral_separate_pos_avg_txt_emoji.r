...
plot_interaction(input_data = sentiment_avg_pos, response_col = "score", 
                 file_name = "mistral_separate_pos_avg_txt_emoji", 
                 y_lower = 5, y_upper = 10, line_title_position = 9.5, 
                 ylab = "mistral_separate_pos_avg_txt_emoji")
...
plot_interaction(input_data = sentiment_avg_pos, response_col = "score_new", 
                 file_name = "mistral_separate_pos_avg_txt_emoji_weighted", 
                 y_lower = 5, y_upper = 10, line_title_position = 9.5, 
                 ylab = "mistral_separate_pos_avg_txt_emoji_weighted")
...
write.csv(wide, "mistral_separate_pos_avg_txt_emoji.csv", row.names = F)
write.csv(wide_weighted, "mistral_separate_pos_avg_txt_emoji_weighted.csv", row.names = F)