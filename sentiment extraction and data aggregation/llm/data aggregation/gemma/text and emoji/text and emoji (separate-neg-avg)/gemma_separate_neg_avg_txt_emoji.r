...
plot_interaction(input_data = sentiment_avg_neg, response_col = "score", 
                 file_name = "gemma_separate_neg_avg_txt_emoji", 
                 y_lower = 0, y_upper = 5, line_title_position = 4.5, 
                 ylab = "gemma_separate_neg_avg_txt_emoji")
...
plot_interaction(input_data = sentiment_avg_neg, response_col = "score_new", 
                 file_name = "gemma_separate_neg_avg_txt_emoji_weighted", 
                 y_lower = 0, y_upper = 5, line_title_position = 4.5, 
                 ylab = "gemma_separate_neg_avg_txt_emoji_weighted")
...
write.csv(wide, "gemma_separate_neg_avg_txt_emoji.csv", row.names = F)
write.csv(wide_weighted, "gemma_separate_neg_avg_txt_emoji_weighted.csv", row.names = F)