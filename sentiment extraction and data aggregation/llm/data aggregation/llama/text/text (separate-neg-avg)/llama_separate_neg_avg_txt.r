...
llama_data <- read_csv("llama_output_separate_text.csv")[,-1]
...
plot_interaction(input_data = sentiment_avg_neg, response_col = "score", 
                 file_name = "llama_separate_neg_avg_txt", 
                 y_lower = 0, y_upper = 5, line_title_position = 4.5, 
                 ylab = "llama_separate_neg_avg_txt")
...
plot_interaction(input_data = sentiment_avg_neg, response_col = "score_new", 
                 file_name = "llama_separate_neg_avg_txt_weighted", 
                 y_lower = 0, y_upper = 5, line_title_position = 4.5, 
                 ylab = "llama_separate_neg_avg_txt_weighted")
...
write.csv(wide, "llama_separate_neg_avg_txt.csv", row.names = F)
write.csv(wide_weighted, "llama_separate_neg_avg_txt_weighted.csv", row.names = F)